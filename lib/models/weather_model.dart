...
/// base : "stations"
/// main : {"temp":302.57,"feels_like":301.66,"temp_min":302.27,"temp_max":302.57,"pressure":1012,"humidity":34}
/// visibility : 10000
/// wind : {"speed":3.6,"deg":20}
/// clouds : {"all":40}
/// dt : 1716984638
/// sys : {"type":1,"id":2514,"country":"EG","sunrise":1716951310,"sunset":1717001403}
/// timezone : 10800
/// id : 360630
/// name : "Cairo"
/// cod : 200
...
class WeatherData {
  ...
  String? _name;
  num? _cod;
WeatherData copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherData(  coord: coord ?? _coord,
